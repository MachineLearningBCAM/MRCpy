...
class LCMRC(BaseMRC):
    ...
    The class LCMRC implements Marginally Constrained Cost Sensitive
    Minimax Risk Classifiers (MRC), an MRC that can use any loss defined
    by a loss matrix. It implements two kinds of prediction methods.
    ...
    **phi_kwargs : Additional parameters for feature mappings.
        ...
        ``LCMRC(phi='fourier', n_components=500)``.
    ...
    def __get_A_b(self, LT):
        ...
        try:
            ...
            raise ImportError(
                "pycddlib is required for LCMRC. "
