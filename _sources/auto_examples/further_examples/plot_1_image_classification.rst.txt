...
.. "auto_examples/further_examples/plot_1_image_classification.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_further_examples_plot_1_image_classification.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_further_examples_plot_1_image_classification.py:
...
.. image-sg:: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_001.png
   :alt: plot 1 image classification
   :srcset: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_001.png
...
.. image-sg:: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_002.png
   :alt: plot 1 image classification
   :srcset: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_003.png
         :alt: plot 1 image classification
         :srcset: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_004.png
         :alt: plot 1 image classification
         :srcset: /auto_examples/further_examples/images/sphx_glr_plot_1_image_classification_004.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_examples_further_examples_plot_1_image_classification.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_1_image_classification.py <plot_1_image_classification.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_1_image_classification.ipynb <plot_1_image_classification.ipynb>`
